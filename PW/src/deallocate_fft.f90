...
subroutine deallocate_fft
  ...
  USE noncollin_module, ONLY : noncolin, deallocate_noncol,&
                               report,i_cons
  ...
  !call deallocate_gvecs() Variables here are moved into dfft type
  !SJ Use CALL fft_type_deallocate( dffts ) instead?
